...
const formatDatePart = (date: Date) => date.toLocaleDateString('en-US', { month: 'long', day: 'numeric' }); // e.g. January 1
const formatDateShort = (date: Date) => date.toLocaleDateString('en-US', { day: 'numeric', month: 'short' }); // e.g. 1st Jan (simplified)
            ...
            <div className="md:hidden">
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="w-full h-12 justify-between text-base font-semibold rounded-xl border bg-card px-4" disabled={isLoading}>
            ...
            <div className="space-y-4 min-h-[400px]">
                {isLoading ? (
                    ...
                    Array.from({ length: 3 }).map((_, i) => (
                        <div key={i} className="flex flex-col md:flex-row gap-6 p-6 rounded-3xl border-2 border-border/50 bg-white">
                    ...
                    <div className="py-20 text-center rounded-3xl border-2 border-red-100 bg-red-50/50">
                        <p className="text-red-500 font-semibold mb-2">Failed to load schedule</p>
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col md:flex-row gap-6 items-center w-full">
                                    ...
                                    <div className="relative w-28 h-28 md:w-32 md:h-32 shrink-0 rounded-2xl overflow-hidden bg-zinc-100 shadow-md">
                                        <Image
                                            src={show.image_url || "/assets/schedule_image.webp"} // Fallback image needed
                                            alt={show.title}
                                            fill
                                    ...
                                    <div className="flex-1 text-center md:text-left space-y-2">
                                        ...
                                        <p className="font-semibold text-muted-foreground text-sm">
                                            {show.presenter?.full_name || show.presenter?.username || "Pie Radio"}
                                        </p>
