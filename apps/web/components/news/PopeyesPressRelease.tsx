...
import { Calendar, Share2, Printer, ChevronLeft } from "lucide-react";
import { Button } from "@/components/ui/button";
import { useRouter } from "next/navigation";

interface PopeyesPressReleaseProps {
  showBackToNews?: boolean;
}

export function PopeyesPressRelease({ showBackToNews = false }: PopeyesPressReleaseProps) {
      ...
      <article className="container max-w-screen-md mx-auto px-4 pt-12">
        ...
        <div className="prose prose-zinc max-w-none text-deep-text/90">
          ...
          <p className="text-lg leading-relaxed mb-6">
            ...
            Chicken Sandwich. To top it all off, Popeyes® is bringing the
            spirit of New Orleans with a performance from Mardi Gras-style band,
            The Brass Funkeys as well as DJ sets from{" "}
            <Link
              href="/"
