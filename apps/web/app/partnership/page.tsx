        ...
        <div className="container relative z-10 h-full max-w-screen-2xl mx-auto px-4 md:px-8 flex flex-col justify-center py-16 sm:py-20 lg:py-24">
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <Image
              ...
              priority
            />
            <span className="text-white/50 text-2xl sm:text-3xl font-thin">
              ×
            </span>
            <Image
          ...
          <p className="text-sm sm:text-base lg:text-lg text-zinc-300 leading-relaxed max-w-xl mb-6 sm:mb-8">
            Pie Radio is proud to partner with Popeyes Louisiana Kitchen — the
            global home of bold, Louisiana-inspired flavor. This exciting
            collaboration blends great food with great sound.
          </p>
