...
import { Loader2, Music, ShieldCheck, Mail } from "lucide-react";
                    ...
                    <div className="space-y-6">
                        <div className="grid gap-4">
                            ...
                            <Button
                                variant="outline"
                                size="lg"
                                className="h-14 w-full rounded-2xl border-2 border-zinc-100 bg-[#f9fafb] text-zinc-400 font-bold gap-3"
                                disabled
                            >
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase font-black tracking-widest text-zinc-300">
                                <span className="bg-[#fcfcfd] px-4">New here?</span>
                            </div>
                        </div>

                        <p className="text-center text-sm text-zinc-500 font-medium">
                            Don&apos;t have an account? <span className="text-primary font-bold cursor-pointer hover:underline">Join the team</span>
                        </p>
                    </div>
