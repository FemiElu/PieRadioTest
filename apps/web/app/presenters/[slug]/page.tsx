...
async function fetchPresenterShows(presenterId: string): Promise<PresenterShow[]> {
    const supabase = await createClient();
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white rounded-3xl border border-border p-6 md:p-8">
                            ...
                            {presenter.bio ? (
                                ...
                                <p className="text-muted-foreground italic">No bio available yet.</p>
                            )}
                        </div>
                            ...
                            {shows.length === 0 ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-10 text-center gap-3">
                                    ...
                                    <p className="text-sm text-muted-foreground max-w-xs">
                                        Shows for this presenter will appear here once they&apos;re added.
                                    </p>
                                </div>
                            ) : (
                                <div className="space-y-4">
